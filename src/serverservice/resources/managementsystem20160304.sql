CREATE DATABASE  IF NOT EXISTS `managementsystem` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `SystemAdministrators` VALUES ('guest','Guest','46fe47e8b67cad6074a7dfd508be9dd9','','dgpc02419','200.200.200.17','2015-04-17 16:33:26',1,1,NULL),('hehui','He Hui','46fe47e8b67cad6074a7dfd508be9dd9','','200.200.200.17','dgpc02419','2015-07-28 07:19:25',0,1,NULL),('test','NNNN111','ddf63c1a8f2492aa4e41b34e93a9d54e','AAA111','dgpc02419','200.200.200.17','2015-04-24 10:25:37',1,0,'RRRRRRR111');
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Admins_Query`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Admin_Delete`( in p_adminID varchar(32) )
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Admin_Login`(in p_adminID varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Admin_Update_Info`(in p_UserID varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Admin_Update_Login_Info`(in p_adminID varchar(32), 
                                                                in p_adminIP varchar(64), 
                                                                in p_adminPC varchar(32) 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Alarms_Acknowledge`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Alarms_GetCount`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Alarms_Insert`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Alarms_Query`(
 in p_AssetNO varchar(32),
 in p_AlarmType tinyint,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_AnnouncementReplies_Insert`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_AnnouncementReplies_Query`(
 in p_AnnouncementID int unsigned,
 in p_Receiver varchar(32)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Announcements_Insert`(
 out p_ID int unsigned,
 in p_Type tinyint,
 in p_Content text,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Announcements_Query`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Announcements_Query3`(
 in p_IDs varchar(255),
 in p_Keyword varchar(32),
 in p_Validity tinyint,
 in p_AssetNO varchar(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Announcements_Update`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_AnnouncementTargets_Insert`(
 in p_AnnouncementID int unsigned,
 in p_AssetNO varchar(32),
 in p_UserName varchar(32)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_AnnouncementTargets_Query`(
 in p_AnnouncementID int unsigned
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_CurrentUTCTimestamp`()
BEGIN
###查询当前的UTC时间
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_AnnouncementTargets_Update`(
 in p_AnnouncementID int unsigned,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Hardware_Query`(in p_AssetNO varchar(32)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Logs_Save`(in p_AssetNO varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_OS_AssetNO_Update`(in p_newAssetNO varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_OS_Query`(in p_AssetNO varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_OS_Update`(in p_AssetNO varchar(32), 
                                                                in p_ComputerName varchar(32), 
                                                                in p_OS varchar(45), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_ProcessMonitorSettings_Update`(
                                                                in p_AssetNO varchar(32), 
                                                                in p_ProcessMonitorEnabled tinyint, 
                                                                in p_Rules text, 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`200.200.200.17` PROCEDURE `sp_Test`(
 in p_Validity tinyint,
 in p_AssetNO varchar(32),
 in p_UserName varchar(32)
...
-- Dump completed on 2016-03-04 14:18:30
