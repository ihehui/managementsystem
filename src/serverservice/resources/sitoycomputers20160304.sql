CREATE DATABASE  IF NOT EXISTS `sitoycomputers` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sitoycomputers`;
...
CREATE TABLE `alarm` (
  ...
  `Type` tinyint(4) DEFAULT NULL COMMENT '1:Hardware Change\n2.Program',
...
-- Dump completed on 2016-03-04 14:19:52
