...
INSERT INTO `Announcements` VALUES (27,1,'11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n11111111111111111111111\n\n',1,'hehui','2015-05-20 06:04:33',0,0,1,1),(28,1,'2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222\n2222222222222222222',1,'hehui','2015-05-20 08:16:35',30,1,1,1),(29,1,'333333333333333333333',0,'hehui','2015-05-20 08:36:11',0,0,1,1),(30,1,'444444444444444',1,'hehui','2015-05-20 08:49:22',30,0,1,1);
...
INSERT INTO `Hardware` VALUES ('china1111','Intel Pentium III Xeon 处理器 CPU 0',NULL,'(1GB,)','QEMU HARDDISK(29GB)',NULL,NULL,NULL,'Realtek RTL8139 Family PCI Fast Ethernet NIC(52:54:00:6D:43:EA)','2015-07-28 07:19:15',NULL),('dgpc02419','Intel(R) Core(TM) i3-3220 CPU @ 3.30GHz LGA1155','ASUSTeK COMPUTER INC. P8H61-M LX3 PLUS R2.0','Kingston(4GB,1333)','ST3500413AS ATA Device(465GB);ST500DM002-1BC142 ATA Device(465GB)','DELF03D','GeForce 9400 GT','VIA High Definition Audio','Realtek PCIe GBE Family Controller(08:60:6E:C4:36:29);VirtualBox Host-Only Ethernet Adapter(08:00:27:00:C0:CB);VirtualBox Bridged Networking Driver Miniport(08:60:6E:C4:36:29)','2015-04-17 15:42:45',NULL),('useruse-i5ceod4','Intel(R) Core(TM) i5-7400 CPU @ 3.00GHz ','Oracle Corporation VirtualBox',NULL,'VBOX HARDDISK ATA Device(19GB);VBOX HARDDISK ATA Device(24GB)',NULL,NULL,'High Definition Audio 设备','Intel(R) PRO/1000 MT Desktop Adapter(08:00:27:88:6D:5B);Intel(R) PRO/1000 MT Desktop Adapter(08:00:27:5B:2F:75)','2018-05-29 07:02:02',NULL);
...
CREATE TABLE `OS` (
  ...
  `ExternalIP` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO `OS` VALUES ('china1111','china-74d290c0d','Microsoft Windows XP Professional Service Pac','2015-04-17','MRX3F-47B9T-2487J-KWKMF-RPWBY','WORKGROUP',0,'hehui','administrator;hehui','200.200.200.106','','2015.5.4.1',0,0,'2015-07-28 07:19:30'),('dgpc02419','dgpc02419','Microsoft Windows 7 旗舰版  Service Pack 1 64-bi','2014-07-29','FJGCP-4DFJD-GJY49-VJBQ7-HYRR2','WORKGROUP',0,'hehui','administrator;hehui','','','2014.12.23.1',0,0,'2015-04-17 15:42:45'),('pc1','pc1','Microsoft Windows XP Professional Service Pac','2015-04-17','MRX3F-47B9T-2487J-KWKMF-RPWBY','WORKGROUP',0,'hehui','administrator;hehui','200.200.200.106','','2014.12.23.1',0,0,'2015-04-28 09:44:02'),('pc2','pc2','Microsoft Windows XP Professional Service Pac','2015-04-17','MRX3F-47B9T-2487J-KWKMF-RPWBY','WORKGROUP',0,'hehui','administrator;hehui','200.200.200.106','','2014.12.23.1',0,0,'2015-04-28 09:44:02'),('pc3','pc3','Microsoft Windows XP Professional Service Pac','2015-04-17','MRX3F-47B9T-2487J-KWKMF-RPWBY','WORKGROUP',0,'hehui','administrator;hehui','200.200.200.106','','2014.12.23.1',0,0,'2015-04-28 09:44:02'),('useruse-i5ceod4','useruse-i5ceod4','Microsoft Windows 7 旗舰版  Service Pack 1 64-bit zh-CN','2018-01-08','FJGCP-4DFJD-GJY49-VJBQ7-HYRR2','WorkGroup',0,'user','administrator;user','192.168.1.160/08:00:27:88:6D:5B;192.168.168.3/08:00:27:88:6D:5B','192.168.1.160:22346','2016.3.21.1',0,0,'2018-05-29 07:02:04');
...
INSERT INTO `SystemAdministrators` VALUES ('guest','Guest','46fe47e8b67cad6074a7dfd508be9dd9','','dgpc02419','200.200.200.17','2015-04-17 16:33:26',1,1,NULL),('hehui','He Hui','46fe47e8b67cad6074a7dfd508be9dd9','','::ffff:127.0.0.1','appdev4','2018-05-29 02:23:00',0,1,NULL),('test','NNNN111','ddf63c1a8f2492aa4e41b34e93a9d54e','AAA111','dgpc02419','200.200.200.17','2015-04-24 10:25:37',1,0,'RRRRRRR111');
...
--
-- Dumping events for database 'managementsystem'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Admins_Query`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Admin_Delete`( in p_adminID varchar(32) )
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Admin_Login`(in p_adminID varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Admin_Update_Info`(in p_UserID varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Admin_Update_Login_Info`(in p_adminID varchar(32), 
                                                                in p_adminIP varchar(64), 
                                                                in p_adminPC varchar(32) 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Alarms_Acknowledge`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Alarms_GetCount`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Alarms_Insert`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Alarms_Query`(
 in p_AssetNO varchar(32),
 in p_AlarmType tinyint,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_AnnouncementReplies_Insert`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_AnnouncementReplies_Query`(
 in p_AnnouncementID int unsigned,
 in p_Receiver varchar(32)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Announcements_Insert`(
 out p_ID int unsigned,
 in p_Type tinyint,
 in p_Content text,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Announcements_Query`(
 in p_IDs varchar(255),
 in p_Keyword varchar(32),
 in p_Validity tinyint,
 in p_TargetAssetNO varchar(32),
 in p_TargetUserName varchar(32),
 in p_TargetType tinyint,
 in p_startTime DateTime,
 in p_endTime DateTime
...
if p_TargetType < 0  then
        ...
        set whereStatement = CONCAT_WS('', whereStatement, ' or tb_ann.ID in (select t.Announcement from AnnouncementTargets t where t.AssetNO  like \'%', p_TargetAssetNO, '%\' and UserName  like \'%', p_TargetUserName, '%\' )');
end if;

if p_TargetType = 1 then
        
        set whereStatement = CONCAT_WS('', whereStatement, ' and tb_ann.ID in (select t.Announcement from AnnouncementTargets t where t.AssetNO  like \'%', p_TargetAssetNO, '%\' and UserName  like \'%', p_TargetUserName, '%\' )');
end if;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_Announcements_Query3` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Announcements_Query3`(
 in p_IDs varchar(255),
 in p_Keyword varchar(32),
 in p_Validity tinyint,
 in p_AssetNO varchar(32),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Announcements_Update`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_AnnouncementTargets_Insert`(
 in p_AnnouncementID int unsigned,
 in p_AssetNO varchar(32),
 in p_UserName varchar(32)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_AnnouncementTargets_Query`(
 in p_AnnouncementID int unsigned
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_AnnouncementTargets_Update`(
 in p_AnnouncementID int unsigned,
...
declare statementDEL varchar(1024) default ' ';
...
if @announcementTargetType=1 then
    ...
    if CHAR_LENGTH(p_deletedTargets) <> 0 then
        set statementDEL = CONCAT_WS(' ',  ' delete from AnnouncementTargets where ID in( ', p_deletedTargets, ' ) ;');
    end if;
    
set @tempstr = concat("),(", p_AnnouncementID, ",");
set @statement = concat(statementDEL, concat("insert into AnnouncementTargets(Announcement,AssetNO,UserName) values(", p_AnnouncementID, ",", replace(p_addedTargets,';',@tempstr)), ");" );
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_CurrentUTCTimestamp`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Hardware_Query`(in p_AssetNO varchar(32)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Logs_Save`(in p_AssetNO varchar(32), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_OS_AssetNO_Update`(in p_newAssetNO varchar(32), 
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_OS_Query`(
                                                          in p_AssetNO varchar(32), 
...
if CHAR_LENGTH(p_externalIP) <> 0 then
set whereStatement = CONCAT_WS('', whereStatement, ' and ExternalIP like \'%', p_externalIP, '%\'');
end if;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_OS_Update`(
                                                            p_AssetNO varchar(32),
                                                            p_ComputerName varchar(32),
                                                            p_OS varchar(128),
                                                            p_InstallationDate TIMESTAMP,
                                                            p_OSKey varchar(45),
                                                            p_Workgroup varchar(32),
                                                            p_JoinedToDomain tinyint,
                                                            p_Users varchar(255),
                                                            p_Admins varchar(255),
                                                            p_IP varchar(255),
                                                            p_externalIP varchar(255),
                                                            p_ClientVersion varchar(32),
                                                            p_USB tinyint
                                                            )
BEGIN
...
if @computerName is null then
        insert into OS values(p_AssetNO, p_ComputerName, p_OS, p_InstallationDate,  p_OSKey, p_Workgroup, p_JoinedToDomain, p_Users, p_Admins, p_IP, p_externalIP, p_ClientVersion, 0, 1, NULL) ;
        insert into Hardware(AssetNO) values(p_AssetNO);
    else
        update OS set 
        ComputerName=p_ComputerName, OSVersion=p_OS, InstallationDate=p_InstallationDate,  OSKey=p_OSKey, Workgroup=p_Workgroup, JoinedToDomain=p_JoinedToDomain, Users=p_Users, Administrators=p_Admins, IP=p_IP, ExternalIP=p_externalIP, ClientVersion=p_ClientVersion, USB=p_USB, LastOnlineTime=NULL
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ProcessMonitorSettings_Update`(
                                                                in p_AssetNO varchar(32), 
                                                                in p_ProcessMonitorEnabled tinyint, 
                                                                in p_Rules text, 
...
-- Dump completed on 2018-05-29 15:29:41
